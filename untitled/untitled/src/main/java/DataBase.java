...
public class DataBase {
    ...
    void addEmployee(Statement statement) throws SQLException{
    ...
    void deleteEmployee(Statement statement) throws SQLException{
        System.out.println("enter some name to deleted:");
        String name=scanner.nextLine();
        String query=String.format("delete from employees where name = '%s'",
                name);
        statement.executeUpdate(query);
    }
}